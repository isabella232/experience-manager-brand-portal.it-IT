...
>[!NOTE]
>
>I video dinamici non sono supportati sui tenant del Brand Portal integrati con AEM Author in esecuzione in modalità di esecuzione di **[!UICONTROL Scene7 Connect]**.
...
* **Avvia AEM Author in modalità** DM (Contenuti multimediali dinamici) Avvia l’istanza di AEM Author (con la quale Brand Portal è integrato) in modalità [ibrido per file multimediali](https://helpx.adobe.com/experience-manager/6-5/assets/using/config-dynamic.html#EnablingDynamicMedia) dinamici oppure in modalità [Contenuti multimediali](https://helpx.adobe.com/experience-manager/6-5/assets/using/config-dms7.html#EnablingDynamicMediainScene7mode)dinamici [!DNL Scene7].
...
2. Dal pannello degli strumenti di amministrazione, selezionate la sezione **[!UICONTROL Video]**.<br />   ![Configurazione ibrida elementi multimediali dinamici su Brand Portal](assets/DMHybrid-Video.png)
   **[!UICONTROL Viene visualizzata la pagina Modifica configurazione]**elemento multimediale dinamico.<br />   ![Dynamic Media Hybrid Configuration on Brand Portal](assets/edit-dynamic-media-config.png)
...
2. Dal pannello degli strumenti di amministrazione, selezionate la sezione Configurazione **[!UICONTROL file multimediali]**dinamica.<br />   ![Configurazione DM [!UICONTROL Scene 7] su Brand Portal](assets/DMS7-Tile.png)
   **[!UICONTROL Viene visualizzata la pagina Modifica configurazione]**elemento multimediale dinamico.<br />   ![Configurazione di Scene7 su Brand Portal](assets/S7Config.png)
