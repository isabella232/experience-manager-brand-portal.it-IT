...
1. Nel campo Nome ****proprietà, aprite il selettore delle proprietà e selezionate la proprietà in base alla quale viene eseguita la ricerca. In alternativa, immettere un nome per la proprietà. Ad esempio, immettere`  jcr :content/metadata/dc:title`o`./jcr:content/metadata/dc:title`.
